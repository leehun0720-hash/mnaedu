...
export const HERO_VARIANTS: HeroVariant[] = [
  {
    ...
    em: "마지막 10%",
    post: "를 가르친다.",
    // 실적 수치는 회장 승인 전 노출 금지(기획 보고서 9장-8) — 문구로만 말한다.
    desc:
      "㈜프론티어 M&A 성보경 회장의 40년 실전 자산을 5레벨 문제로 온라인에서 가려내고, 오프라인에서 실제 딜을 다루는 소수정예 과정.",
  },
  {
    id: "B",
    label: "B · 전장에서 배운다",
  ...
  },
  {
    ...
    post: "에게 남긴다.",
    desc:
      "1993년 국내 최초 M&A 전문회사 설립 이후 쌓아 온 실전 강의 노트와 딜 경험. 성보경 회장의 판단을 소수정예가 직접 이어받습니다.",
  },
];
